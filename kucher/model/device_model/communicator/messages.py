...
class Codec:
    ...
    def __init__(self, version_major_minor: typing.Tuple[int, int]):
        ...
        if self._version[0] > 1:
            raise UnsupportedVersionException(
                "Cannot communicate with version %r" % self._version
            )
        ...
        self._type_mapping: typing.Dict[MessageType, typing.Tuple[int, con.Struct]] = {
            ...
            MessageType.DEVICE_CHARACTERISTICS: (
                1,
                DeviceCharacteristicsMessageFormatV1,
            ),
    ...
    def decode(self, frame: popcop.transport.ReceivedFrame) -> Message:
        for mt, (frame_type_code, formatter) in self._type_mapping.items():
            ...
            raise UnknownMessageException(
                "Unknown frame type code when decoding: %r" % frame.frame_type_code
            )
    ...
    def encode(
        self, message: typing.Union[Message, MessageType]
        ...
        try:
            ...
            raise UnknownMessageException(
                "Unknown message type when encoding: %r" % message.type
            )
