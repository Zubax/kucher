...
class TaskStatisticsView:
    ...
    entries: typing.Dict[TaskID, SingleTaskStatistics] = dataclasses.field(
    ...
    def populate(msg: typing.Mapping) -> "TaskStatisticsView":
        return TaskStatisticsView(
            ...
            entries={
                TASK_ID_MAPPING[item["task_id"]][0]: SingleTaskStatistics.populate(item)
                for item in msg["entries"]
            },
        )
