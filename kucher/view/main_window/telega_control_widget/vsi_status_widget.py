...
class VSIStatusWidget(ValueDisplayGroupWidget):
    ...
    def __init__(self, parent: QWidget):
        ...
        self._vsi_driver_state = self.create_value_display(
            "VSI state", placeholder, "VSI driver state"
        )

        self._pwm_frequency = self.create_value_display(
            "PWM frq.", placeholder, "PWM carrier frequency"
        )

        self._current_agc_level = self.create_value_display(
            "IAGC lvl.",
            placeholder,
    ...
    def set(
        ...
        self._current_agc_level.set(
            "High gain" if current_agc_is_high_level else "Low gain"
        )
