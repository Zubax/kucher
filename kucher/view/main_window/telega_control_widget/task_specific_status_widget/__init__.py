...
class TaskSpecificStatusWidget(GroupBoxWidget):
    ...
    def __init__(self, parent: QWidget):
        super(TaskSpecificStatusWidget, self).__init__(
            parent, _DEFAULT_TITLE, _DEFAULT_ICON
        )
...
def _load_widgets():
    ...
    for tid in TaskID:
        ...
        try:
            ...
            _logger.info(
                f"Module is not defined - no task-specific status info for task {tid!r} is available"
            )
        else:
