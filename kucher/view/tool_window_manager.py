...
class ToolWindowManager:
    ...
    def __init__(self, parent_window: QMainWindow):
        ...
        dock_options = (
            self._parent_window.AnimatedDocks | self._parent_window.AllowTabbedDocks
        )
    ...
    def register(
        ...
        factory: typing.Union[
            typing.Type[QWidget], typing.Callable[[ToolWindow], QWidget]
        ],
        title: str,
    ...
    def add_arrangement_rule(
        ...
        self._arrangement_rules.append(
            _ArrangementRule(
                apply_to=list(apply_to), group_when=group_when, location=location
            )
        )
    ...
    def _select_tool_windows(
        self, widget_type: typing.Type[QWidget]
    ) -> typing.List[ToolWindow]:
        return [win for win in self._children if isinstance(win.widget, widget_type)]

    def _select_applicable_arrangement_rules(
        self, widget_type: typing.Type[QWidget]
    ) -> typing.List["_ArrangementRule"]:
        return [
            copy.deepcopy(ar)
            for ar in self._arrangement_rules
    ...
    def _reiconize(self, *_):
        ...
        # other widgets.
        to_a_bar = self._parent_window.findChildren(
            QTabBar, "", Qt.FindDirectChildrenOnly
        )
